    ...
    ui(new Ui::MainWindow), settings("plainoldprogrammer", "pos")
{
    ...
    ui->setupUi(this);
    this->setWindowTitle("Pos v0.9 (Beta)");
...
bool MainWindow::createDBConnection()
{
    ...
    QString dbFolder = "C:\\Plainoldprogrammer_dev\\Pos\\db\\";
...
bool MainWindow::createTicketsTable()
{
    QSqlQuery sqlQuery;
